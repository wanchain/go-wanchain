...
make && build/bin/gwan --pluto --rpc --ipcpath ~/Library/Wanchain/gwan.ipc --etherbase "0x9da26fc2e1d6ad9fdd46138906b0104ae68a65d8" --unlock "0x9da26fc2e1d6ad9fdd46138906b0104ae68a65d8" --password /tmp/pw.txt --rpc  --mine --minerthreads=1 --verbosity 3
