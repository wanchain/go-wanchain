...
#make && build/bin/gwan --pluto --rpc --ipcpath ~/Library/Wanchain/gwan.ipc --nodiscover --etherbase "0x2d0e7c0813a51d3bd1d08246af2a8a7a57d8922e" --unlock "0x2d0e7c0813a51d3bd1d08246af2a8a7a57d8922e" --password /tmp/pw.txt --rpc  --mine --minerthreads=1 --syncmode "full"
make && build/bin/gwan --pluto --rpc --ipcpath ~/Library/Wanchain/gwan.ipc --etherbase "0x9da26fc2e1d6ad9fdd46138906b0104ae68a65d8" --unlock "0x9da26fc2e1d6ad9fdd46138906b0104ae68a65d8" --password /tmp/pw.txt --rpc --syncmode "full"
#--mine --minerthreads=1 --verbosity 3  --verbosity 3
