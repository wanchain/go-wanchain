...
if [ $? -eq 1 ]; then
	docker run --restart always --name wanchainContainer -itd -v $SRCDIR:/wanchain/src -p 8545:8545 registry.cn-hangzhou.aliyuncs.com/wanglutech/wanchaindev /bin/sh
fi
