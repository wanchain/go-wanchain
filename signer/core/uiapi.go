...
func (s *UIServerAPI) ImportRawKey(privkey0, privKey1 string, password string) (accounts.Account, error) {
	...
	// No error
	return fetchKeystore(s.am).ImportECDSA(key0, key1, password)
}
