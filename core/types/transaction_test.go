...
func TestTransactionSigHash(t *testing.T) {
	if emptyTx.SigHash(HomesteadSigner{}) != common.HexToHash("4085bdfcd57b2d59c6e56a6ec60b92302313f58e19b9c54eff76effaadeb85c6") {
		t.Errorf("empty transaction hash mismatch, got %x", emptyTx.Hash())
	}
	if rightvrsTx.SigHash(HomesteadSigner{}) != common.HexToHash("fa22b6a9ead25cec443cd10bf69a807f5bcc269f943b0f319509fbdc535308ed") {
...
func TestTransactionEncode(t *testing.T) {
	...
	should := common.FromHex("f8660103018207d094b94f5374fce5edbc8e2a8697c15331677e6ebf0b0a8255441ca098ff921201554726367d2be8c804a7ff89ccf285ebc57dff8ae4c44b9c19ac4aa08887321be575c8095f789dd4c743dfe42c1820f9231f98a962b210e3ac2452a3c0c0c0c0")
...
// zhihuizhilv revise:因为环签名,Sender无法从tx中获得发送者,所以该用例已过时
