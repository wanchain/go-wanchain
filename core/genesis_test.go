...
func TestSetupGenesis(t *testing.T) {
	var (
		...
		customg     = Genesis{
			Config: &params.ChainConfig{HomesteadBlock: big.NewInt(3), PosFirstBlock: big.NewInt(3600000)},
			Alloc: GenesisAlloc{
	...
	oldcustomg.Config = &params.ChainConfig{HomesteadBlock: big.NewInt(2), PosFirstBlock: big.NewInt(3600000)}
	tests := []struct {
		name       string
