...
func TestCreation(t *testing.T) {
	...
	tests := []struct {
		...
		// Mainnet test cases
		{
			params.MainnetChainConfigEth,
			params.MainnetGenesisHashEth,
			[]testcase{
...
func TestValidation(t *testing.T) {
	...
	for i, tt := range tests {
		filter := newFilter(params.MainnetChainConfigEth, params.MainnetGenesisHashEth, func() uint64 { return tt.head })
