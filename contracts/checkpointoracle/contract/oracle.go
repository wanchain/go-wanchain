...
// constructor(address[] _adminlist, uint256 _sectionSize, _processConfirms, _threshold)
// NewCheckpointVote(uint64 indexed index, bytes32 checkpointHash, uint8 v, bytes32 r, bytes32 s)()
// GetAllAdmin()(address[])
// GetLatestCheckpoint()(uint64, bytes32, uint256)
// SetCheckpoint(uint256 _recentNumber, bytes32 _recentHash, _hash, uint64 _sectionIndex, uint8[]v, bytes32[] r,s)
